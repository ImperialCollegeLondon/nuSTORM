...
print (f"piDcyYpos failed {piDcyYPos[0]} passed {piDcyYPos[1]}")
print (f"piDcyZpos failed {piDcyZPos[0]} passed {piDcyZPos[1]}")
print (f"piDcyPx failed {piDcyPx[0]} passed {piDcyPx[1]}")
print (f"piDcyPy failed {piDcyPy[0]} passed {piDcyPy[1]}")
print (f"piDcyPz failed {piDcyPz[0]} passed {piDcyPz[1]}")
print (f"Energy conservation at pion decay failed {piDcyE[0]} passed {piDcyE[1]}")
print (f"pion decay pion on mass shell failed {piDcyMassShell[0]} passed {piDcyMassShell[1]}")
print (f"pion decay muon on mass shell failed {piDcyMuMassShell[0]} passed {piDcyMuMassShell[1]}")
print (f"pion decay neutrino on mass shell failed {piDcyNuMassShell[0]} passed {piDcyNuMassShell[1]}")
